...
def predict_test(target):
    ...
    assert np.allclose(pred, [[0.72445526, 0.46920652, 0.55395658]]), f"Wrong values for pred. {pred} != {[[0.72445526, 0.46920652, 0.55395658]]}"
...
def model_test(target):
    ...
    expected_output = {'costs': [np.array(0.69314718)], 
                   'Y_prediction_test': np.array([[0.56395209, 0.52296171, 0.48813819]]), 
                   'Y_prediction_train': np.array([[0.53910992, 0.51876251, 0.43515677, 0.61257594, 0.44466678, 0.47994866, 0.57673387]]), 
